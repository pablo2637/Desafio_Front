            ...
            <tbody className='text-[0.6rem]'>
                {
                    ...
                    places.map(p =>
                        <tr key={p.place_id} className='border-b'>
                            <td className='text-left'><NavLink to={`/placeDetail/${p.place_id}`} >{p.place_name}</NavLink></td>
                            <td className='text-left px-5'><NavLink to={`/placeDetail/${p.place_id}`} >{p.contact_name}</NavLink></td>
                            <td className='text-left pr-5'><NavLink to={`/placeDetail/${p.place_id}`} >{p.email}</NavLink></td>
