...
export const Map = () => {
    ...
    const handleOnFindMe = () => {
        ...
        if (coords?.lat)
            current.flyTo([coords.lat, coords.long], 16);
    ...
    return (
        ...
        <section className='secMap'>
            ...
            <div className="map" id="map" >
                ...
                <MapContainer ref={mapRef} center={position} zoom={16} scrollWheelZoom={false} zoomControl={true} attributionControl={false}>
                    <TileLayer
